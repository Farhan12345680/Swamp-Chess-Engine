...
bool fenStringValidator(char *FEN_STRING)
{
         ...
         i++)
    {
        if (_state == PIECE_PLACEMENT)
        {
            ...
            int _blackPawn = _asciiArray['p'];
            int _whitePawn = _asciiArray['P'];
            ...
            if (_asciiArray['k'] != 1 ||
                ...
                _asciiArray['q'] > (9 - _blackPawn) ||
                _asciiArray['Q'] > (9 - _whitePawn) ||

                _asciiArray['b'] > (10 - _blackPawn) ||
                _asciiArray['B'] > (10 - _whitePawn) ||

                _asciiArray['r'] > (10 - _blackPawn) ||
                _asciiArray['R'] > (10 - _whitePawn) ||

                _asciiArray['n'] > (10 - _blackPawn) ||
                _asciiArray['N'] > (10 - _whitePawn) ||
