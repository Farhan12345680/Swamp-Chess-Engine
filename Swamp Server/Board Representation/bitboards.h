...
typedef enum{
    WHITE_KING , WHITE_QUEEN , WHITE_BISHOP, WHITE_KNIGHT, WHITE_ROOK,
    BLACK_KING, BLACK_QUEEN , BLACK_BISHOP , BLACK_KNIGHT , BLACK_ROOK
} Pieces;
...
GameState initiaizeNewGame(){
    ...
    _newState._occupancy = 
                        ...
                        _newState._blackKnights ^ _newState._blackBishops
                         ^ _newState._blackQueens ^
